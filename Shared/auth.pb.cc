...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_auth_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::auth::CreateAccountWebFailure, reason_),
  0,
  1,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_auth_2eproto = {
  false, false, 701, descriptor_table_protodef_auth_2eproto, "auth.proto", 
...
constexpr CreateAccountWebFailure_FailureReason CreateAccountWebFailure::ACCOUNT_ALREADY_EXISTS;
constexpr CreateAccountWebFailure_FailureReason CreateAccountWebFailure::INVALID_PASSWORD;
constexpr CreateAccountWebFailure_FailureReason CreateAccountWebFailure::INTERNAL_SERVER_ERROR;
constexpr CreateAccountWebFailure_FailureReason CreateAccountWebFailure::FailureReason_MIN;
constexpr CreateAccountWebFailure_FailureReason CreateAccountWebFailure::FailureReason_MAX;
constexpr int CreateAccountWebFailure::FailureReason_ARRAYSIZE;
...
#if (__cplusplus < 201703) && (!defined(_MSC_VER) || _MSC_VER >= 1900)
constexpr AuthenticateWebFailure_FailureReason AuthenticateWebFailure::INVALID_CREDENTIALS;
constexpr AuthenticateWebFailure_FailureReason AuthenticateWebFailure::INTERNAL_SERVER_ERROR;
constexpr AuthenticateWebFailure_FailureReason AuthenticateWebFailure::FailureReason_MIN;
constexpr AuthenticateWebFailure_FailureReason AuthenticateWebFailure::FailureReason_MAX;
constexpr int AuthenticateWebFailure::FailureReason_ARRAYSIZE;
#endif  // (__cplusplus < 201703) && (!defined(_MSC_VER) || _MSC_VER >= 1900)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::auth::CreateAccountWebFailure_FailureReason_IsValid(val))) {
            _internal_set_reason(static_cast<::auth::CreateAccountWebFailure_FailureReason>(val));
          } else {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::auth::AuthenticateWebFailure_FailureReason_IsValid(val))) {
            _internal_set_reason(static_cast<::auth::AuthenticateWebFailure_FailureReason>(val));
          } else {
            ::PROTOBUF_NAMESPACE_ID::internal::WriteVarint(2, val, mutable_unknown_fields());
          }
        } else
