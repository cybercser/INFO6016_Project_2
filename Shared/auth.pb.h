...
constexpr CreateAccountWebFailure_FailureReason CreateAccountWebFailure_FailureReason_FailureReason_MAX = CreateAccountWebFailure_FailureReason_INTERNAL_SERVER_ERROR;
constexpr int CreateAccountWebFailure_FailureReason_FailureReason_ARRAYSIZE = CreateAccountWebFailure_FailureReason_FailureReason_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* CreateAccountWebFailure_FailureReason_descriptor();
template<typename T>
inline const std::string& CreateAccountWebFailure_FailureReason_Name(T enum_t_value) {
  static_assert(::std::is_same<T, CreateAccountWebFailure_FailureReason>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function CreateAccountWebFailure_FailureReason_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    CreateAccountWebFailure_FailureReason_descriptor(), enum_t_value);
}
inline bool CreateAccountWebFailure_FailureReason_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, CreateAccountWebFailure_FailureReason* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<CreateAccountWebFailure_FailureReason>(
...
constexpr AuthenticateWebFailure_FailureReason AuthenticateWebFailure_FailureReason_FailureReason_MAX = AuthenticateWebFailure_FailureReason_INTERNAL_SERVER_ERROR;
constexpr int AuthenticateWebFailure_FailureReason_FailureReason_ARRAYSIZE = AuthenticateWebFailure_FailureReason_FailureReason_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* AuthenticateWebFailure_FailureReason_descriptor();
template<typename T>
inline const std::string& AuthenticateWebFailure_FailureReason_Name(T enum_t_value) {
  static_assert(::std::is_same<T, AuthenticateWebFailure_FailureReason>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function AuthenticateWebFailure_FailureReason_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    AuthenticateWebFailure_FailureReason_descriptor(), enum_t_value);
}
inline bool AuthenticateWebFailure_FailureReason_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, AuthenticateWebFailure_FailureReason* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<AuthenticateWebFailure_FailureReason>(
    AuthenticateWebFailure_FailureReason_descriptor(), name, value);
}
// ===================================================================
...
class CreateAccountWebFailure final :
 ...
 public:
  ...
  typedef CreateAccountWebFailure_FailureReason FailureReason;
  static constexpr FailureReason ACCOUNT_ALREADY_EXISTS =
    CreateAccountWebFailure_FailureReason_ACCOUNT_ALREADY_EXISTS;
  static constexpr FailureReason INVALID_PASSWORD =
    CreateAccountWebFailure_FailureReason_INVALID_PASSWORD;
  static constexpr FailureReason INTERNAL_SERVER_ERROR =
    CreateAccountWebFailure_FailureReason_INTERNAL_SERVER_ERROR;
  static inline bool FailureReason_IsValid(int value) {
    return CreateAccountWebFailure_FailureReason_IsValid(value);
  }
  static constexpr FailureReason FailureReason_MIN =
    CreateAccountWebFailure_FailureReason_FailureReason_MIN;
  static constexpr FailureReason FailureReason_MAX =
    CreateAccountWebFailure_FailureReason_FailureReason_MAX;
  static constexpr int FailureReason_ARRAYSIZE =
    CreateAccountWebFailure_FailureReason_FailureReason_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  FailureReason_descriptor() {
    return CreateAccountWebFailure_FailureReason_descriptor();
  }
  template<typename T>
  static inline const std::string& FailureReason_Name(T enum_t_value) {
    ...
    return CreateAccountWebFailure_FailureReason_Name(enum_t_value);
  }
  static inline bool FailureReason_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      FailureReason* value) {
    return CreateAccountWebFailure_FailureReason_Parse(name, value);
  }
  ...
  // optional .auth.CreateAccountWebFailure.FailureReason reason = 2;
  bool has_reason() const;
  private:
  bool _internal_has_reason() const;
  public:
  void clear_reason();
  ::auth::CreateAccountWebFailure_FailureReason reason() const;
  void set_reason(::auth::CreateAccountWebFailure_FailureReason value);
  private:
  ::auth::CreateAccountWebFailure_FailureReason _internal_reason() const;
  void _internal_set_reason(::auth::CreateAccountWebFailure_FailureReason value);
  public:
...
class AuthenticateWebFailure final :
 ...
 public:
  ...
  typedef AuthenticateWebFailure_FailureReason FailureReason;
  static constexpr FailureReason INVALID_CREDENTIALS =
    AuthenticateWebFailure_FailureReason_INVALID_CREDENTIALS;
  static constexpr FailureReason INTERNAL_SERVER_ERROR =
    AuthenticateWebFailure_FailureReason_INTERNAL_SERVER_ERROR;
  static inline bool FailureReason_IsValid(int value) {
    return AuthenticateWebFailure_FailureReason_IsValid(value);
  }
  static constexpr FailureReason FailureReason_MIN =
    AuthenticateWebFailure_FailureReason_FailureReason_MIN;
  static constexpr FailureReason FailureReason_MAX =
    AuthenticateWebFailure_FailureReason_FailureReason_MAX;
  static constexpr int FailureReason_ARRAYSIZE =
    AuthenticateWebFailure_FailureReason_FailureReason_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  FailureReason_descriptor() {
    return AuthenticateWebFailure_FailureReason_descriptor();
  }
  template<typename T>
  static inline const std::string& FailureReason_Name(T enum_t_value) {
    static_assert(::std::is_same<T, FailureReason>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function FailureReason_Name.");
    return AuthenticateWebFailure_FailureReason_Name(enum_t_value);
  }
  static inline bool FailureReason_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      FailureReason* value) {
    return AuthenticateWebFailure_FailureReason_Parse(name, value);
  }
  ...
  // optional .auth.AuthenticateWebFailure.FailureReason reason = 2;
  bool has_reason() const;
  private:
  bool _internal_has_reason() const;
  public:
  void clear_reason();
  ::auth::AuthenticateWebFailure_FailureReason reason() const;
  void set_reason(::auth::AuthenticateWebFailure_FailureReason value);
  private:
  ::auth::AuthenticateWebFailure_FailureReason _internal_reason() const;
  void _internal_set_reason(::auth::AuthenticateWebFailure_FailureReason value);
  public:
...
inline ::auth::CreateAccountWebFailure_FailureReason CreateAccountWebFailure::_internal_reason() const {
  return static_cast< ::auth::CreateAccountWebFailure_FailureReason >(reason_);
}
inline ::auth::CreateAccountWebFailure_FailureReason CreateAccountWebFailure::reason() const {
  // @@protoc_insertion_point(field_get:auth.CreateAccountWebFailure.reason)
  return _internal_reason();
}
inline void CreateAccountWebFailure::_internal_set_reason(::auth::CreateAccountWebFailure_FailureReason value) {
  assert(::auth::CreateAccountWebFailure_FailureReason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  reason_ = value;
}
inline void CreateAccountWebFailure::set_reason(::auth::CreateAccountWebFailure_FailureReason value) {
  _internal_set_reason(value);
  // @@protoc_insertion_point(field_set:auth.CreateAccountWebFailure.reason)
}
...
inline ::auth::AuthenticateWebFailure_FailureReason AuthenticateWebFailure::_internal_reason() const {
  return static_cast< ::auth::AuthenticateWebFailure_FailureReason >(reason_);
}
inline ::auth::AuthenticateWebFailure_FailureReason AuthenticateWebFailure::reason() const {
  // @@protoc_insertion_point(field_get:auth.AuthenticateWebFailure.reason)
  return _internal_reason();
}
inline void AuthenticateWebFailure::_internal_set_reason(::auth::AuthenticateWebFailure_FailureReason value) {
  assert(::auth::AuthenticateWebFailure_FailureReason_IsValid(value));
  _has_bits_[0] |= 0x00000002u;
  reason_ = value;
}
inline void AuthenticateWebFailure::set_reason(::auth::AuthenticateWebFailure_FailureReason value) {
  _internal_set_reason(value);
...
template <> struct is_proto_enum< ::auth::CreateAccountWebFailure_FailureReason> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::auth::CreateAccountWebFailure_FailureReason>() {
  return ::auth::CreateAccountWebFailure_FailureReason_descriptor();
}
template <> struct is_proto_enum< ::auth::AuthenticateWebFailure_FailureReason> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::auth::AuthenticateWebFailure_FailureReason>() {
  return ::auth::AuthenticateWebFailure_FailureReason_descriptor();
}
